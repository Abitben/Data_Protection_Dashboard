    ...
    create or replace table `cnil-392113`.`dev_dbt_intermediate`.`int_listes_sanctions__secteur`
...
FROM `cnil-392113`.`dev_dbt_intermediate`.`int_listes_sanctions__amount` as list
