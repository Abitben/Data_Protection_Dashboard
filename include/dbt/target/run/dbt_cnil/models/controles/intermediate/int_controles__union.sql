    ...
    create or replace table `cnil-392113`.`dev_dbt_intermediate`.`int_controles__union`
  ...
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2014`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2015`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2016`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2017`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2018`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2019`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2020`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2021`
  UNION ALL
  SELECT
    *
  FROM
    `cnil-392113`.`dev_dbt_staging`.`stg_controles_2022`
  ORDER BY
    annee
)
SELECT
